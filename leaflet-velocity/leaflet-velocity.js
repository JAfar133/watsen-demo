...
var Windy = function Windy(params) {
  ...
  var PARTICLE_MULTIPLIER = params.particleMultiplier || 1 / 320; // particle count scalar (completely arbitrary--this values looks nice)
  ...
  var animate = function animate(bounds, field, north) {
  ...
  var start = function start(bounds, width, height, extent) {
    ...
    buildGrid(gridData, function (grid) {
      ...
      interpolateField(grid, buildBounds(bounds, width, height), mapBounds, function (bounds, field) {
        ...
        windy.field = field;
        animate(bounds, field,extent[1][1]);
      });
    });
  };
